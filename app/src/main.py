...
class SMARTWIPERSCONTROLApp(VehicleApp):
    """Velocitas App for SMARTWIPERSCONTROL."""
...
async def main():
    logger.info("Starting SMARTWIPERSCONTROLApp...")
    vehicle_app = SMARTWIPERSCONTROLApp(vehicle)
